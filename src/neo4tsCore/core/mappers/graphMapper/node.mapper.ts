...
export class NodeMapper {
    ...
    getInputNode([alias, graphNode]: AliasedNode): Node {
        ...
        node.id = id;
        node.properties = graphNode.properties? this.propertyMapper.getPropertiesFromDto(graphNode.properties) : [];
        node.isReturnable = graphNode.isReturnable != null? graphNode.isReturnable : true;
        node.isOptional = graphNode.isOptional != null? graphNode.isOptional : false;
